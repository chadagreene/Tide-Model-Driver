...
%% Syntax 
% 
%  [pu,pf] = tmd_nodal(t,cid)
%
%% Description 
% 
% [pu,pf] = tmd_nodal(t,cid) returns nodal corrections pu(:,nc),pf(:,nc) for
% constituents cid given by a cell array. Time t is in datenum or datetime
% format. 
% t - mjd, cid(nc,4) - tidal constituents array 
