...
# Getting Tide Models
After you [add TMD3.0 to MATLAB](installing_tmd.md), you'll need to get one or more tide model files. Click on any of the links below to download these. For TMD3.0, these will always be NetCDF ( \*.nc) files, but they may be compressed into files with a .zip extension, in which case, unzip them and you'll be ready to start using TMD3.0.
