...
% 
% This script takes about 10 minutes to run on my laptop from 2019. 
...
netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'),'Data_citation',['Susan L. Howard and Laurie Padman. 2021. Gr1kmTM: Greenland 1 kilometer Tide Model, 2021. (for DOI details, search at https://arcticdata.io/ for ''Gr1kmTM'')'])
...
% % Chunking 
% netcdf.defVarChunking(ncid,hRe_var_id,'CHUNKED',[1095 1765 8]);
% netcdf.defVarChunking(ncid,hIm_var_id,'CHUNKED',[1095 1765 8]);
% netcdf.defVarChunking(ncid,uRe_var_id,'CHUNKED',[1095 1765 8]);
% netcdf.defVarChunking(ncid,uIm_var_id,'CHUNKED',[1095 1765 8]);
% netcdf.defVarChunking(ncid,vRe_var_id,'CHUNKED',[1095 1765 8]);
% netcdf.defVarChunking(ncid,vIm_var_id,'CHUNKED',[1095 1765 8]);
